...
describe("Query Operators E2E", () => {
  ...
  beforeAll(async () => {
    ...
    await model.create([
      {
        name: "Alpha Widget",
        description: "Professional alpha grade widget",
        category: "widgets",
        price: 29.99,
        stock: 100,
        isActive: true,
      ...
      {
        name: "Beta Gadget",
        description: "Consumer beta gadget",
        category: "gadgets",
        price: 49.99,
        stock: 50,
        isActive: true,
      ...
      {
        name: "Gamma Device",
        description: "Industrial gamma device",
        category: "devices",
        price: 199.99,
        stock: 10,
        isActive: true,
      ...
      {
        name: "Delta Tool",
        description: "Basic delta hand tool",
        category: "tools",
        price: 9.99,
        stock: 200,
        isActive: true,
      ...
      {
        name: "Epsilon Gizmo",
        description: "Experimental epsilon gizmo",
        category: "gadgets",
        price: 149.99,
        stock: 5,
        isActive: false,
      ...
      {
        name: "Zeta Widget",
        description: "Economy zeta widget",
        category: "widgets",
        price: 14.99,
        stock: 0,
        isActive: false,
        tags: ["budget", "clearance"],
      },
    ]);
