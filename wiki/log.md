...
- 2026-08-19 — events — outbox relay failures default to structured `fastify.log`; explicit `onError` still overrides. changelog/v2.md#2340.
- 2026-08-17 — core, permissions — `nativePolicyFilter()` brands adapter-native policy; `mergeFilters` keeps the symbol brand it used to drop. changelog/v2.md#2340.
