...
---
- 2026-08-25 — hooks — `after(res,'list'|'read')` registered but never fired (around DID, which hid it); now fires at the result, 404 excluded. Wiki listed 4 read KEYS on `defineResource({hooks})` that never existed.
