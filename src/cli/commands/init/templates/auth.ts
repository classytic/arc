...
export const authResource = defineResource({
  ...
  routes: [
    ...
    },
    {
      ...
      permissions: allowPublic(),
      rawHandler: handlers.refreshToken,
    ...
    },
    {
      ...
      permissions: allowPublic(),
      rawHandler: handlers.forgotPassword,
    ...
    },
    {
      ...
      permissions: allowPublic(),
      rawHandler: handlers.resetPassword,
  ...
  routes: [
    {
      ...
      rawHandler: handlers.getUserProfile,
    ...
    },
    {
      ...
      permissions: requireAuth(),
      rawHandler: handlers.updateUserProfile,
